              ...
              <div className="md:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                  ...
                  <div className="flex items-center gap-2 px-3 py-2">
                    <Link href="/en" className="px-3 py-1 rounded text-gray-700 text-sm">
                      🇬🇧 EN
                    </Link>
                    <Link href="/th" className="px-3 py-1 rounded bg-red-600 text-white text-sm">
                      🇹🇭 TH
                    </Link>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Link href="/th/areas" className="bg-white hover:bg-gray-50 font-bold px-8 py-4 rounded-lg shadow-xl hover:shadow-2xl transform hover:md:scale-105 transition-all duration-300 text-center border-2" style={{borderColor: '#800020', color: '#800020'}}>
