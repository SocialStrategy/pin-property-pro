            ...
            {mobileMenuOpen && (
              <div className="md:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                  <Link 
                    href={locale === 'th' ? '/th/blog' : '/en/blog'} 
                  ...
                  <Link 
                    href={locale === 'th' ? '/th/areas' : '/en/areas'} 
                    className="block px-3 py-2 text-gray-700 hover:text-red-600 hover:bg-gray-50 rounded-md"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    {locale === 'th' ? 'พื้นที่' : 'Areas'}
                  ...
                  <Link 
                    href={locale === 'th' ? '/th/testimonials' : '/en/testimonials'} 
                  ...
                  <Link 
                    href={locale === 'th' ? '/th/contact' : '/en/contact'} 
                    className="block px-3 py-2 text-gray-700 hover:text-red-600 hover:bg-gray-50 rounded-md"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    {locale === 'th' ? 'ติดต่อ' : 'Contact'}
                  ...
                  <div className="flex items-center gap-2 px-3 py-2">
                    <Link href="/en/testimonials" className={`px-3 py-1 rounded text-sm ${locale === 'en' ? 'bg-red-600 text-white' : 'text-gray-700'}`}>
                      🇬🇧 EN
                    </Link>
