              ...
              <div className="md:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                  ...
                  <div className="flex items-center gap-2 px-3 py-2">
                    <Link href={`/en/blog/${slug}`} className={`px-3 py-1 rounded text-sm ${locale === 'en' ? 'bg-red-600 text-white' : 'text-gray-700'}`}>
                      🇬🇧 EN
                    </Link>
                    <Link href={`/th/blog/${slug}`} className={`px-3 py-1 rounded text-sm ${locale === 'th' ? 'bg-red-600 text-white' : 'text-gray-700'}`}>
                      🇹🇭 TH
                    </Link>
                  </div>
                </div>
