          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-6">
                ...
                <Link href={locale === 'th' ? '/th/testimonials' : '/testimonials'} className="text-gray-700 hover:text-red-600">
                ...
                <div className="flex items-center gap-2">
                  <Link href={router.asPath.replace('/th', '') || '/'} className={`px-3 py-1 rounded ${locale === 'en' ? 'bg-red-600 text-white' : 'text-gray-700'}`}>
                    🇬🇧 EN
                  </Link>
                  <Link href={`/th${router.asPath === '/' ? '' : router.asPath}`} className={`px-3 py-1 rounded ${locale === 'th' ? 'bg-red-600 text-white' : 'text-gray-700'}`}>
                    🇹🇭 TH
                  </Link>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Link href={locale === 'th' ? '/th/areas' : '/areas'} className="bg-white hover:bg-gray-50 font-bold px-8 py-4 rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center border-2" style={{borderColor: '#800020', color: '#800020'}}>
        ...
        <section className="py-24 text-white" style={{background: 'linear-gradient(135deg, #800020 0%, #660019 50%, #4d0013 100%)'}}>
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href={locale === 'th' ? '/th/contact' : '/contact'} className="font-bold text-lg px-8 py-4 rounded-lg shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 text-center" style={{backgroundColor: '#F9F9DC', color: '#800020'}}>
            ...
            <div className="flex items-center justify-center gap-6 pt-8 text-red-200">
              <div className="flex items-center gap-2">
                ...
                <span>{locale === 'th' ? 'ไม่มีค่าธรรมเนียมซ่อนเร้น' : 'No Hidden Fees'}</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5" />
                <span>{locale === 'th' ? 'อสังหาริมทรัพย์ที่ตรวจสอบแล้ว' : 'Verified Properties'}</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5" />
                <span>{locale === 'th' ? 'สนับสนุน 24/7' : '24/7 Support'}</span>
              </div>
            </div>
          </div>
        </section>
